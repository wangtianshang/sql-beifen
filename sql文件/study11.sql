...
-- ----------------------------
INSERT INTO `community_topic` VALUES (1, 'django自学', '学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习dj', 456, 19, '2019-04-03 14:50:00', 1, 0, 'topic/2019/04/django.jpg', 8);
INSERT INTO `community_topic` VALUES (2, 'django中的admin使用', 'admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django', 50, 3, '2019-04-03 14:50:00', 1, 0, 'topic/2019/04/django2.jpg', 8);
INSERT INTO `community_topic` VALUES (3, '自学成才', '这是一篇 Python 入门指南，针对那些没有任何编程经验，从零开始学习 Python 的同学。不管你学习的出发点是兴趣驱动、拓展思维，还是工作需要、想要转行，都可以此文作为一个参考。', 2, 1, '2019-04-03 17:20:00', 2, 0, 'topic/2019/04/python_ngQzs0v.jpg', 0);
...
INSERT INTO `courses_course` VALUES (3, 'python入门', 'python入门', 'python入门python入门python入门python入门python入门', 'zj', 0, 0, 0, 'courses/2016/11/540e57300001d6d906000338-240-135.jpg', 1, '2016-11-05 16:07:00', 4, '后端开发', '', NULL, '', '', 0);
...
INSERT INTO `courses_course` VALUES (7, 'django与vuejs实战项目', 'python入门2', '<p>&nbsp; &nbsp; python入门2\r\npython入门2\r\npython入门2\r\npython入门2\r\npython入门2</p>', 'zj', 0, 7, 0, 'courses/2019/04/vue2.jpg', 20, '2016-11-05 16:09:00', 2, '后端开发', '前端开发', NULL, 'go语言', '前端开发', 1);
...
INSERT INTO `django_session` VALUES ('y8vz4at2n7pl6gnfc8nj7yfrc26clo4j', 'ZTVhZWU3ZjY3ZmI4MDg2NDZhMWExNTNiNmUzMTZiMzQ1ZWZhZWUyMTp7Il9hdXRoX3VzZXJfaWQiOiIxMyIsIl9hdXRoX3VzZXJfYmFja2VuZCI6InVzZXJzLnZpZXdzLkN1c3RvbUJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI4NzYyOGU4NzA3Njg4NTE2ZDJhYWRhOTdkYzBmMGRlOWYzOWVhYjk5IiwidWlkIjoxM30=', '2019-04-24 15:46:37');
...
INSERT INTO `organization_courseorg` VALUES (4, '南京大学', '慕课网是垂直的互联网IT技能免费学习网站。以独家视频教程、在线编程工具、学习计划、问答社区为核心特色。在这里，你可以找到最好的互联网技术牛人，也可以通过免费的在线公开视频课程学习国内领先的互联网IT技术。\r\n    慕课网课程涵盖前端开发、PHP、Html5、Android、iOS、Swift等IT前沿技术语言，包括基础课程、实用案例、高级分享三大类型，适合不同阶段的学习人群。以纯干货、短视频的形式为平台特点，为在校学生、职场白领提供了一个迅速提升技能、共同分享进步的学习平台。[1] \r\n4月2日，国内首个IT技能学习类应用——慕课网3.1.0版本在应用宝首发。据了解，在此次上线的版本中，慕课网新增了课程历史记录、相关课程推荐等四大功能，为用户营造更加丰富的移动端IT学习体验。[2]', 6, 0, 'org/2016/11/njdx.jpg', '南京市', '2016-11-02 18:53:00', 4, 'pxjg', 0, 0, '全国知名');
...
-- ----------------------------
INSERT INTO `organization_teacher` VALUES (1, 'bobby', 5, 'xxx', 'xxx', 'xxx', 26, 1, '2016-11-03 23:43:00', 1, 'teacher/2016/11/aobama_CXWwMef.png', 18);
INSERT INTO `organization_teacher` VALUES (2, '还是bobby', 5, 'xxx', 'xxx', 'xxx', 5, 1, '2016-11-03 23:44:00', 1, 'teacher/2016/11/aobama.png', 18);
...
INSERT INTO `organization_teacher` VALUES (4, '王浩', 0, '河南科技学院', '软件工程师', '牛逼', 0, 0, '2019-04-08 17:01:00', 2, 'teacher/2019/04/java3.jpg', 23);
...
INSERT INTO `users_userprofile` VALUES (8, 'pbkdf2_sha256$36000$VrfBgTlZFzdB$NpcNpe2jEfAkulMVa/jp0xaQu6s0lM/lS9mTevmqWVI=', '2019-04-10 15:45:01', 1, 'wang', '', '', '1@2.com', 1, 1, '2019-04-01 10:37:51', 'myself', '2019-04-06', 'female', '河南', 'None', 'image/2019/04/QQ截图20190312204019_yXhNDbJ.png');
...
INSERT INTO `users_userprofile` VALUES (13, 'pbkdf2_sha256$36000$94Y5tTqKnHp6$lz8S8boW9H29cSyNnsMMdI0IHNi6azzelwI/KCVy+r4=', '2019-04-10 15:46:37', 1, 'nihao', '', '', '1@2.com', 1, 1, '2019-04-07 18:59:22', '年后', '2019-04-07', 'male', '很那', 'None', 'image/2019/04/other.jpg');
