...
-- ----------------------------
INSERT INTO `captcha_captchastore` VALUES (264, 'MLIN', 'mlin', '5495ab1a04575be620844321fd0a05fb6b48cc19', '2019-04-17 15:58:32');
INSERT INTO `captcha_captchastore` VALUES (263, 'DPHI', 'dphi', '04db4e51dd5702f88643478255f08b0ce956e1bd', '2019-04-17 15:58:02');
INSERT INTO `captcha_captchastore` VALUES (262, 'QBFF', 'qbff', '50320dd3a468cba00812f13789a19d486064ccf7', '2019-04-17 15:57:56');
INSERT INTO `captcha_captchastore` VALUES (259, 'LKCP', 'lkcp', '610ecce859daba66538f886fd1c050fa1fcd5a8f', '2019-04-14 22:20:39');
INSERT INTO `captcha_captchastore` VALUES (260, 'JKZK', 'jkzk', '9b3e46a05d9982977d2348e84389b7491a079b4e', '2019-04-17 15:56:53');
INSERT INTO `captcha_captchastore` VALUES (261, 'VJCL', 'vjcl', 'e9b602f2be4d425998394c710bdf67853829b34f', '2019-04-17 15:57:53');
...
-- ----------------------------
INSERT INTO `community_topic` VALUES (1, 'django自学', '学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习dj', 457, 19, '2019-04-03 14:50:00', 1, 0, 'topic/2019/04/django.jpg', 8);
...
INSERT INTO `community_topic` VALUES (3, '自学成才', '这是一篇 Python 入门指南，针对那些没有任何编程经验，从零开始学习 Python 的同学。不管你学习的出发点是兴趣驱动、拓展思维，还是工作需要、想要转行，都可以此文作为一个参考。', 8, 1, '2019-04-03 17:20:00', 2, 0, 'topic/2019/04/python_ngQzs0v.jpg', 0);
...
INSERT INTO `django_session` VALUES ('87h15u54uhi9zmeh5z5r4w35i19gke5m', '', '2019-05-01 15:58:56');
...
INSERT INTO `operation_userfavorite` VALUES (35, 1, 2, '2019-04-08 19:18:28', 13);
INSERT INTO `operation_userfavorite` VALUES (36, 13, 1, '2019-04-08 22:35:02', 13);
INSERT INTO `operation_userfavorite` VALUES (37, 10, 1, '2019-04-17 15:02:09', 13);
...
INSERT INTO `operation_usermessage` VALUES (58, 8, '有人回复了你的评论', 0, '2019-04-13 14:40:13');
INSERT INTO `operation_usermessage` VALUES (59, 13, '有人回复了你的回复', 1, '2019-04-13 14:40:38');
INSERT INTO `operation_usermessage` VALUES (60, 8, '有人回复了你的回复', 0, '2019-04-13 14:41:02');
...
INSERT INTO `organization_courseorg` VALUES (6, '迷你', '<p>&nbsp; &nbsp; 慕课网是垂直的互联网IT技能免费学习网站。以独家视频教程、在线编程工具、学习计划、问答社区为核心特色。在这里，你可以找到最好的互联网技术牛人，也可以通过免费的在线公开视频课程学习国内领先的互联网IT技术。\r\n &nbsp; &nbsp;慕课网课程涵盖前端开发、PHP、Html5、Android、iOS、Swift等IT前沿技术语言，包括基础课程、实用案例、高级分享三大类型，适合不同阶段的学习人群。以纯干货、短视频的形式为平台特点，为在校学生、职场白领提供了一个迅速提升技能、共同分享进步的学习平台。[1] \r\n4月2日，国内首个IT技能学习类应用——慕课网3.1.0版本在应用宝首发。据了解，在此次上线的版本中，慕课网新增了课程历史记录、相关课程推荐等四大功能，为用户营造更加丰富的移动端IT学习体验。[2]</p>', 0, 0, 'org/2019/04/u2943570432939388060fm26gp0.jpg', '天津市', '2016-11-02 18:54:00', 6, 'pxjg', 1, 0, '全国知名');
...
-- ----------------------------
INSERT INTO `organization_teacher` VALUES (1, 'Peter', 5, 'xxx', 'xxx', 'xxx', 35, 1, '2016-11-03 23:43:00', 1, 'teacher/2019/04/u2894296377760208308fm26gp0.jpg', 18);
INSERT INTO `organization_teacher` VALUES (2, '大教授', 5, 'xxx', 'xxx', 'xxx', 5, 1, '2016-11-03 23:44:00', 1, 'teacher/2019/04/b7fd5266d0160924c427f4d4d80735fae7cd34fa.jpg', 18);
...
INSERT INTO `organization_teacher` VALUES (4, '王浩', 0, '河南科技学院', '软件工程师', '牛逼', 3, 0, '2019-04-08 17:01:00', 2, 'teacher/2019/04/java3.jpg', 23);
INSERT INTO `organization_teacher` VALUES (5, '琼斯', 12, '河南科技学院', '软件工程师', '牛逼', 6, 0, '2019-04-17 12:08:00', 5, 'teacher/2019/04/python.jpg', 18);
...
INSERT INTO `users_userprofile` VALUES (8, 'pbkdf2_sha256$36000$VrfBgTlZFzdB$NpcNpe2jEfAkulMVa/jp0xaQu6s0lM/lS9mTevmqWVI=', '2019-04-13 14:40:27', 1, 'wang', '', '', '1@2.com', 1, 1, '2019-04-01 10:37:51', 'myself', '2019-04-06', 'female', '河南', 'None', 'image/2019/04/QQ截图20190312204019_yXhNDbJ.png');
...
INSERT INTO `users_userprofile` VALUES (13, 'pbkdf2_sha256$36000$94Y5tTqKnHp6$lz8S8boW9H29cSyNnsMMdI0IHNi6azzelwI/KCVy+r4=', '2019-04-17 15:57:39', 1, 'nihao', '', '', '1@2.com', 1, 1, '2019-04-07 18:59:22', '年后', '2019-04-07', 'male', '很那', 'None', 'image/2019/04/other.jpg');
INSERT INTO `users_userprofile` VALUES (17, 'pbkdf2_sha256$36000$8KRrxeSqMwNb$PI07Mu2ToY2OQgRNPHs5tJ4FnBJteqMCrySn0MD4WYs=', '2019-04-13 00:26:06', 0, '1241814506@qq.com', '', '', '1241814506@qq.com', 0, 1, '2019-04-13 00:22:30', '', NULL, 'female', '', NULL, 'image/default.png');
INSERT INTO `users_userprofile` VALUES (18, 'pbkdf2_sha256$36000$wycHNjEKexBW$/wtmodc8KsnyP3VSTdAzxjQaFWpiPznE4cm/1T9iciY=', NULL, 0, '1@222.com', '', '', '1@222.com', 0, 0, '2019-04-13 20:28:46', '', NULL, 'female', '', NULL, 'image/default.png');
INSERT INTO `users_userprofile` VALUES (16, 'pbkdf2_sha256$36000$r4MmR4gBzLS6$TSmV0VHVlpkwD3U/3s6W1YKrPVQLoW+MyIBCrHQq6sY=', '2019-04-12 18:33:09', 1, 'nini', '', '', '', 1, 1, '2019-04-12 18:25:00', 'nini', NULL, 'female', '河南', NULL, 'image/2019/04/QQ截图20190411225112_kkzWyhS.png');
