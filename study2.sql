...
-- ----------------------------
INSERT INTO `captcha_captchastore` VALUES (231, 'EUTK', 'eutk', '3f5de2ac0ae8548d6eb64731a1425d0c9658cf8f', '2019-04-02 22:49:50');
INSERT INTO `captcha_captchastore` VALUES (230, 'NZAY', 'nzay', 'e1e48da44138c9a42e8a02356c6a585382b2b9ba', '2019-04-02 22:49:15');
INSERT INTO `captcha_captchastore` VALUES (228, 'YQRI', 'yqri', '10276bc30bc509523e58a2320835efc6e7f611d6', '2019-04-02 17:13:34');
INSERT INTO `captcha_captchastore` VALUES (232, 'OLZH', 'olzh', 'e631012b8e706a54317dd279862134caab9bd60a', '2019-04-02 22:50:50');
...
CREATE TABLE `community_topic`  (
  ...
  `topic_user_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `community_topic` VALUES (1, 'django自学', '学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习django这么些年学习dj', 19, 12, '2019-04-03 14:50:00', 1, 0, NULL, 'topic/2019/04/django.jpg');
INSERT INTO `community_topic` VALUES (2, 'django中的admin使用', 'admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是djangoadmin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django中自带的后台管理系统admin是django', 11, 0, '2019-04-03 14:50:00', 1, 0, NULL, 'topic/2019/04/django2.jpg');
INSERT INTO `community_topic` VALUES (3, '自学成才', '这是一篇 Python 入门指南，针对那些没有任何编程经验，从零开始学习 Python 的同学。不管你学习的出发点是兴趣驱动、拓展思维，还是工作需要、想要转行，都可以此文作为一个参考。', 0, 0, '2019-04-03 17:20:00', 2, 0, NULL, 'topic/2019/04/python_ngQzs0v.jpg');
INSERT INTO `community_topic` VALUES (4, '那些年刷过的java', 'Java是一门面向对象编程语言，不仅吸收了C++语言的各种优点，还摒弃了C++里难以理解的多继承、指针等概念，因此Java语言具有功能强大和简单易用两个特征。Java语言作为静态面向对象编程语言的代表，极好地实现了面向对象理论，允许程序员以优雅的思维方式进行复杂的编程 [1]  。', 0, 0, '2019-04-03 17:21:00', 3, 0, NULL, 'topic/2019/04/Java2.jpg');
INSERT INTO `community_topic` VALUES (5, '装饰器', '装饰器本质上是一个Python函数，它可以让其他函数在不需要做任何代码变动的前提下增加额外功能，装饰器的返回值也是一个函数对象。它经常用于有切面需求的场景，比如：插入日志、性能测试、事务处理、缓存、权限校验等场景。装饰器是解决这类问题的绝佳设计，有了装饰器，我们就可以抽离出大量与函数功能本身无关的雷同代码并继续重用。', 1, 0, '2019-04-03 17:22:00', 2, 0, NULL, 'topic/2019/04/java3.jpg');
INSERT INTO `community_topic` VALUES (6, '匿名函数', '当我们在传入函数时，有些时候，不需要显式地定义函数，直接传入匿名函数更方便。当我们在传入函数时，有些时候，不需要显式地定义函数，直接传入匿名函数更方便。当我们在传入函数时，有些时候，不需要显式地定义函数，直接传入匿名函数更方便。', 0, 0, '2019-04-03 17:23:00', 2, 0, NULL, 'topic/2019/04/python2.jpg');
INSERT INTO `community_topic` VALUES (7, 'jdbc之对面的女孩看过来', 'JDBC（Java Data Base Connectivity,java数据库连接）是一种用于执行SQL语句的Java API，可以为多种关系数据库提供统一访问，它由一组用Java语言编写的类和接口组成。JDBC提供了一种基准，据此可以构建更高级的工具和接口，使数据库开发人员能够编写数据库应用程序。', 0, 0, '2019-04-03 17:24:00', 3, 0, NULL, 'topic/2019/04/java.jpg');
INSERT INTO `community_topic` VALUES (8, 'python你好', '我最喜欢python，从17年开始自学，后来自己做项目，写爬虫，不亦乐乎', 0, 0, '2019-04-03 20:48:00', 2, 0, NULL, 'topic/2019/04/python.jpg');
INSERT INTO `community_topic` VALUES (9, '好好学习', '· 学海真的无涯吗？到底什么样的“知识”值得我们花精力去学？\r\n知识无穷无尽，但掌控这个世界运行的底层规律是有限的。你需要的是从海量知识中辨别出其中的“王炸”，一通百通！\r\n学海非无涯，知识有主次。\r\n· 为什么学习“学习的方法”，比学习本身更重要？ [1] \r\n世界这么大，而我们的智慧有限。只有掌握了更有效的学习方法，才能在极为有限的时间里，把自己的认知水平比别人多往前推进一厘米。', 0, 0, '2019-04-04 21:01:00', 3, 0, NULL, 'topic/2019/04/python2_z5jAnrq.jpg');
...
INSERT INTO `courses_course` VALUES (7, 'django与vuejs实战项目', 'python入门2', '<p>&nbsp; &nbsp; python入门2\r\npython入门2\r\npython入门2\r\npython入门2\r\npython入门2</p>', 'zj', 0, 4, 0, 'courses/2016/11/540e57300001d6d906000338-240-135_Z3HIQ2t.jpg', 13, '2016-11-05 16:09:00', 2, '后端开发', '前端开发', NULL, 'go语言', '前端开发', 1);
...
INSERT INTO `django_session` VALUES ('eirtav7mbxu4nzpyqrpjzcrc7x5z2qq1', '', '2019-04-18 21:08:16');
...
-- ----------------------------
INSERT INTO `organization_teacher` VALUES (1, 'bobby', 5, 'xxx', 'xxx', 'xxx', 19, 1, '2016-11-03 23:43:00', 1, 'teacher/2016/11/aobama_CXWwMef.png', 18);
...
INSERT INTO `users_userprofile` VALUES (8, 'pbkdf2_sha256$36000$VrfBgTlZFzdB$NpcNpe2jEfAkulMVa/jp0xaQu6s0lM/lS9mTevmqWVI=', '2019-04-03 23:15:34', 1, 'wang', '', '', '1@2.com', 1, 1, '2019-04-01 10:37:51', 'myself', '2019-04-04', 'female', '河南', 'None', 'image/2019/04/QQ截图20190312204019_kXAhUDb.png');
